...
const Navbar = () => {
  ...
  return (
    <div
      className={`max-w-screen-3xl container mx-auto md:px-20 px-4 fixed top-0 right-0 left-0 z-50 
      bg-base-100 dark:bg-slate-900 dark:text-white
      ${
        sticky
          ? "shadow-md transition-all duration-300 ease-in-out dark:bg-slate-800"
          : ""
      }`}
    >
      <div className="navbar bg-base-100 dark:bg-transparent">
        ...
        <div className="navbar-end space-x-4">
          ...
          <div className="hidden md:block">
            <label className="input outline-none border w-54 flex items-center">
              <svg
